...
CIHM::TDR::REST::tdrmeta - Subclass of Role::REST::Client used to
interact with "tdrmeta" CouchDB databases

=head1 SYNOPSIS

    my $t_repo = CIHM::TDR::REST::internalmeta->new($args);
